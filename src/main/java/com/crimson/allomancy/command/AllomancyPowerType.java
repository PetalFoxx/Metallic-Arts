...
public class AllomancyPowerType implements ArgumentType<String> {
    ...
    private static final Set<String> types = new HashSet<>(Arrays.asList("none", "iron_misting", "steel_misting", "tin_misting", "pewter_misting", "zinc_misting", "brass_misting", "copper_misting", "bronze_misting"));
