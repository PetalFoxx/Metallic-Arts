...
public class MetalPurifierContainer extends Container {
	...
	private final IInventory tileBrewingStand;
	   ...
	   public MetalPurifierContainer(int p_i50095_1_, PlayerInventory p_i50095_2_) {
	      this(p_i50095_1_, p_i50095_2_, new Inventory(5), new IntArray(2));
	   }

	   public MetalPurifierContainer(int p_i50096_1_, PlayerInventory p_i50096_2_, IInventory p_i50096_3_, IIntArray p_i50096_4_) {
	      ...
	      this.addSlot(new MetalPurifierContainer.PotionSlot(p_i50096_3_, 0, 56, 51));
	      this.addSlot(new MetalPurifierContainer.PotionSlot(p_i50096_3_, 1, 79, 58));
	      this.addSlot(new MetalPurifierContainer.PotionSlot(p_i50096_3_, 2, 102, 51));
	      this.slot = this.addSlot(new MetalPurifierContainer.IngredientSlot(p_i50096_3_, 3, 79, 17));
	      this.addSlot(new MetalPurifierContainer.FuelSlot(p_i50096_3_, 4, 17, 17));
	   ...
	   public ItemStack transferStackInSlot(PlayerEntity playerIn, int index) {
	      ...
	      if (slot != null && slot.getHasStack()) {
	         ...
	         if ((index < 0 || index > 2) && index != 3 && index != 4) {
	            ...
	            } else if (MetalPurifierContainer.PotionSlot.canHoldPotion(itemstack) && itemstack.getCount() == 1) {
