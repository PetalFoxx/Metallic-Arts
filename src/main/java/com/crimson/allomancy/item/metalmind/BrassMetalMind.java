...
public class BrassMetalMind extends MetalMindItem {

	public BrassMetalMind() {
		super(new Item.Properties().group(Registry.allomancy_group));
		this.setRegistryName(Allomancy.MODID, "brass_metal_mind");
		this.metal = AllomancyCapability.BRASS;
