...
public class BronzeMetalMind extends MetalMindItem {

	public BronzeMetalMind() {
		super(new Item.Properties().group(Registry.allomancy_group));
		this.setRegistryName(Allomancy.MODID, "bronze_metal_mind");
		this.metal = AllomancyCapability.BRONZE;
